...
import com.stacks.bandersnatch1.vuforia.SampleAppRenderer;
import com.stacks.bandersnatch1.vuforia.SampleAppRendererControl;
import com.stacks.bandersnatch1.vuforia.SampleApplicationSession;
import com.stacks.bandersnatch1.vuforia.SampleRendererBase;
import com.stacks.bandersnatch1.vuforia.utils.CubeShaders;
import com.stacks.bandersnatch1.vuforia.utils.LoadingDialogHandler;
import com.stacks.bandersnatch1.vuforia.utils.MeshObject;
import com.stacks.bandersnatch1.vuforia.utils.SampleApplication3DModel;
import com.stacks.bandersnatch1.vuforia.utils.SampleMath;
import com.stacks.bandersnatch1.vuforia.utils.SampleUtils;
import com.stacks.bandersnatch1.vuforia.utils.Teapot;
...
public class ImageTargetRenderer extends SampleRendererBase implements SampleAppRendererControl
{
    ...
    private final WeakReference<ImageTargetsActivity> mActivityRef;
...
//    }
    ...
    ImageTargetRenderer(ImageTargetsActivity activity, SampleApplicationSession session, Context context)
    {
        ...
        if(!mModelIsLoaded)
        {
            ...
            try {
                ...
                mBuildingsModel.loadModel(mActivityRef.get().getResources().getAssets(),
                        "ImageTargetsActivity/Buildings.txt");
                mModelIsLoaded = true;
            } catch (IOException e)
            {
...
//                    ((SampleActivityBase)context).finish();
                    return;
                }
//                timer = null;
